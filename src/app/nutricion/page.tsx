...
// Nota: la dieta quedó fuera del reto "100 Días" (Santiago la maneja a
// conciencia, sin regla binaria) — este tracker de macros sigue disponible
// como herramienta personal, pero ya no escribe nada en `days`/`diet_done`.
