...
export const MEAL_PREP: MealPrepSession[] = [
  {
    ...
    items: [
      ...
      { name: 'Pan árabe casero integral (opcional)', raw: '250g harina integral + 250g harina 000 + 300ml agua + 7g levadura + 5g sal + 15g aceite', portions: '8 panes de ~90 g' },
    ],
    tips: [
...
export const RECIPES: Recipe[] = [
  ...
  // ── Antojos vueltos fit (comfort food reinterpretado, cierra igual en macros) ──
  {
    name: 'Hamburguesa fit (pan árabe casero)',
    meal: 'Almuerzo o cena',
    time: '15 min',
  ...
  },
  {
    ...
    meal: 'Almuerzo o cena',
    time: '25 min',
    batch: ['180 g de pechuga de pollo'],
    extras: [
      '25 g de pan rallado',
    ...
    steps: [
      'Aplanar la pechuga, pasar por huevo batido y pan rallado',
      'Horno con rocío vegetal, 200°C, 12 min de un lado',
  ...
  },
  {
    ...
    batch: ['150 g de carne picada magra cocida'],
    extras: [
      '1 pan árabe casero (90 g), cortado en triángulos',
      'Lechuga, tomate y cebolla picados',
      '40 g de yogur natural sin azúcar (de crema agria)',
    ],
    steps: [
      'Cortar el pan árabe en triángulos y hornear 5-6 min hasta que quede crocante',
      'Calentar la carne picada con comino y pimentón',
  ...
  },
  {
    ...
    meal: 'Cena',
    time: '40 min (rinde 3-4 porciones)',
    batch: ['150 g de pollo cocido'],
    extras: [
    ...
    steps: [
      ...
      'Formar tiras y cortar en trocitos, hervir hasta que floten (2-3 min)',
  ...
  },
  {
    ...
    meal: 'Almuerzo o cena',
    time: '15 min',
    batch: ['180 g de pollo cocido'],
    extras: [
      '1 pan árabe casero (90 g)',
      'Comino, pimentón y ajo en polvo',
      '40 g de yogur natural sin azúcar',
      'Pepino, tomate y lechuga',
    ],
    steps: [
      'Espolvorear el pollo con comino, pimentón y ajo en polvo, calentar',
      'Tibiar el pan árabe',
